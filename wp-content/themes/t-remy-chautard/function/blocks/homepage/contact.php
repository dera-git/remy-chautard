<section class="swiper-slide kl-section-contact-home kl-section-contact">
    <div class="kl-container-fluid kl-max-w-540-mobile">
        <?php 
            $image = get_field('image_bloc_contact_home');
            if( $image): 
                $image_id = $image['ID'];
                $image_alt = $image['alt']; 
        ?>
            <div class="kl-contact-img d-none d-md-block">
        ...
        <div class="kl-contact-content kl-color-white">
            <div class="kl-contact-content-left">
                <?php if( get_field('titre_bloc_contact_home') ): ?>
                    <div class="kl-contact-title">
                        <h2 class="kl-title-section kl-text-100 mb-1 mb-md-2">
                            <?php the_field('titre_bloc_contact_home') ?>
                        </h2>
                        <?php if( get_field('sous_titre_bloc_contact_home') ): ?>
                            <h3 class="kl-text-40 kl-fw-extra-light mb-md-2 text-uppercase">
                                <?php the_field('sous_titre_bloc_contact_home') ?>
                            </h3>
                        <?php endif ?>
                    </div>
                <?php endif ?>
